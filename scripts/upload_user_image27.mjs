...
async function uploadImage(filename, targetSlug) {
...
async function main() {
  await uploadImage('media__1780310288659.jpg', 'dsip-5mg');
  await uploadImage('media__1780310303772.jpg', 'epitalon-50mg');
}
